...
class _OrgSignupScreenState extends State<OrgSignupScreen> {
  ...
  bool _isOrganisation = false; // Track if the user is an organisation
    ...
    try {
      final response = await Supabase.instance.client.auth.signUp(
        ...
        data: {
          ...
          'user_type':'organisation', // Set user type
        },
      );
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                // Individual Button (White Background with Border)
                                 TextButton(
                                  onPressed: () {
                                ...
                                // Organisation Button (Gradient Background)
                                ElevatedButton(
                                  onPressed: () {
                                    setState(() {
                                      _isOrganisation = true; // Set user type to organisation
                                    });
                                  },
                                  style: ElevatedButton.styleFrom(
                                    padding: const EdgeInsets.symmetric(
                                    ...
                                    backgroundColor: _isOrganisation
                                        ? Colors.transparent
